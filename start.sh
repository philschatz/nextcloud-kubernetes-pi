...
kubectl apply -f ./deployments/nextcloud-namespace.yaml
...
kubectl apply -f ./deployments/nextcloud-ingress.yaml
kubectl apply -f ./deployments/homepage-ingress.yaml
